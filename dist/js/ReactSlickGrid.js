...
var ReactSlickGrid = React.createClass({
  ...
  _initializeSlickData: function _initializeSlickData() {
  ...
  _initializeSlickGrid: function _initializeSlickGrid() {
  ...
  _onSort: function _onSort(event, args) {
    ...
    if (this.props.endpoint) {
      ...
      this._loader.data.sort(function (a, b) {
        var sortVal = 0;
  ...
  _addSortIndicator: function _addSortIndicator(sortDirection) {
    this._cleanSortIndicators((function () {
      if (sortDirection === 'DESC') {
        $('#' + this.props.id).find('.slick-sort-indicator-desc').html('<i class="fa fa-sort-desc"></i>');
      } else {
        $('#' + this.props.id).find('.slick-sort-indicator-asc').html('<i class="fa fa-sort-asc"></i>');
      }
    }).bind(this));
  },

  _cleanSortIndicators: function _cleanSortIndicators(callback) {
  ...
  _onColumnResize: function _onColumnResize(event) {
  ...
  _onViewportChange: function _onViewportChange(event, args) {
  ...
  _onDataLoaded: function _onDataLoaded(event, args) {
  ...
  _generateColumns: function _generateColumns(loader) {
    var columns = [];
  ...
  _getParameters: function _getParameters(minimum, maximum, limit, sortColumn, sortDirection) {
    return {
  ...
  _autoResizeGrid: function _autoResizeGrid() {
